...
const examplesData = [
  {
    exampleNum: "01",
    exampleTitle: "Principles for structuring state",
  },
  {
    exampleNum: "02",
    exampleTitle: "Group related state",
  },
  {
    exampleNum: "03",
    exampleTitle: "Avoid contradictions in state",
  },
  {
    exampleNum: "04",
    exampleTitle: "Avoid redundant state",
  },
  {
    exampleNum: "05",
    exampleTitle: "Avoid duplication in state",
  },
  {
    exampleNum: "06",
    exampleTitle: "Avoid deeply nested state",
  },
];
